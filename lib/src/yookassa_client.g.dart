...
class _YookassaClient implements YookassaClient {
  ...
  Future<YookassaRefund> createRefund({
    required CreateRefundRequest refundRequest,
    String? idempotenceKey,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    ...
    _headers.removeWhere((k, v) => v == null);
    final _data = <String, dynamic>{};
    _data.addAll(refundRequest.toJson());
    final _options = _setStreamType<YookassaRefund>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late YookassaRefund _value;
    try {
      _value = YookassaRefund.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  @override
  Future<YookassaRefund> getRefundInfo({required String refundId}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<YookassaPaymentMethodObject> createPaymentMethod({
    required CreatePaymentMethodRequest request,
    String? idempotenceKey,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    ...
    final _options = _setStreamType<YookassaPaymentMethodObject>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late YookassaPaymentMethodObject _value;
    try {
      _value = YookassaPaymentMethodObject.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<YookassaPaymentMethodObject> getPaymentMethod({
    ...
    final _options = _setStreamType<YookassaPaymentMethodObject>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'https://api.yookassa.ru/v3/payment_methods/${paymentMethodId}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
